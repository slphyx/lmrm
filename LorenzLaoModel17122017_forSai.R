#############   Simple model for Lao pf elimination    ###########

#setwd("C:/Users/lisa/Dropbox/0_Backup_Ddrive/Data_Current/Lorenz")
...
scenario_0<-c(2017.5,1,0,0,0,0,0)
scenario_i<-c(2017.5,1,1,1,1,1,1)
